...
public class EmployeeHierarchy {
    ...
    // Build tree, Recursion, Time O(n), Space O(h), n is number of employees, h is
    // levels of hierarchy tree
    ...
    // Get subordinates list by given id, Time O(n), Space O(k) ~ O(n), k is number
    // of subordinates
